...
public class Calculator implements ActionListener {
    ...
    JButton negButton;
    JPanel panel;
    Font myFont = new Font("Comic Sans", 1, 30);
    double num1 = 0.0;
    double num2 = 0.0;
    double result = 0.0;
    char operator;
    ...
    Calculator() {
        ...
        this.delButton.setBounds(50, 430, 100, 50);
        this.clrButton.setBounds(150, 430, 100, 50);
        this.equButton.setBounds(250, 430, 100, 50);
